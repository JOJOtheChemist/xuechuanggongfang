<template>
	<view class="task-center-hero-overlay">
		<view class="task-center-stage task-center-stage-top">
			<image class="task-center-stage-bg" :src="topBackgroundUrl" mode="widthFix" />
		</view>

		<view class="task-center-stage task-center-stage-top-buttons">
			<image class="task-center-stage-bg" :src="topButtonsBackgroundUrl" mode="widthFix" />
			<view class="task-center-stage-overlay task-center-stage-overlay-top-buttons">
				<task-center-hero-stats-panel ref="statsPanel" class="task-center-hero-stats-panel" />
			</view>
		</view>

		<view v-if="primaryBannerUrl" class="task-center-banner-stage">
			<image class="task-center-banner-image" :src="primaryBannerUrl" mode="widthFix" />
		</view>

		<view class="task-center-stage task-center-stage-progress" @tap="goToGoalSetting">
			<image class="task-center-stage-bg" :src="monthProgressBackgroundUrl" mode="widthFix" />
			<view class="task-center-stage-overlay task-center-stage-overlay-progress">
		...
		<view class="task-center-stage task-center-stage-ranking">
			<image class="task-center-stage-bg" :src="rankingDynamicsBackgroundUrl" mode="widthFix" />
			<view class="task-center-stage-overlay task-center-stage-overlay-ranking">
		...
		<view class="task-center-stage task-center-stage-links">
			<image class="task-center-stage-bg" :src="knowledgeGrowthBackgroundUrl" mode="widthFix" />
			<view class="task-center-stage-overlay task-center-stage-overlay-links">
		...
		<view class="task-center-stage task-center-stage-plan" @tap="goToGoalSetting">
			<image class="task-center-stage-bg" :src="monthPlanBackgroundUrl" mode="widthFix" />
			<view class="task-center-stage-overlay task-center-stage-overlay-plan">
		...
		<view class="task-center-scroll-spacer"></view>
	</view>
</template>
...
const TOP_BUTTONS_BACKGROUND_URL = 'https://xuechuang.xyz/oss/share-assets/admission/admin/images/0/2026/05/26/d82dcf73-963c-46b6-86db-b2c2511a8322.webp'
const MONTH_PROGRESS_BACKGROUND_URL = 'https://xuechuang.xyz/oss/share-assets/admission/admin/images/0/2026/05/26/52d8aa71-5c79-49c1-b351-3c3ea43bf9de.webp'
const RANKING_DYNAMICS_BACKGROUND_URL = 'https://xuechuang.xyz/oss/share-assets/admission/admin/images/0/2026/05/26/b0ce9092-be5b-48f8-abe3-6cb838a870d0.webp'
const KNOWLEDGE_GROWTH_BACKGROUND_URL = 'https://xuechuang.xyz/oss/share-assets/admission/admin/images/0/2026/05/26/4d33e4c1-a091-4f69-8675-1e3d03625942.webp'
const MONTH_PLAN_BACKGROUND_URL = 'https://xuechuang.xyz/oss/share-assets/admission/admin/images/0/2026/05/26/f022d3b2-4336-40f0-a395-1cacbd4c55d6.webp'
...
export default {
	...
	data() {
		return {
			...
			completedCount: 0,
			planItems: [],
			topButtonsBackgroundUrl: TOP_BUTTONS_BACKGROUND_URL,
			monthProgressBackgroundUrl: MONTH_PROGRESS_BACKGROUND_URL,
			rankingDynamicsBackgroundUrl: RANKING_DYNAMICS_BACKGROUND_URL,
			knowledgeGrowthBackgroundUrl: KNOWLEDGE_GROWTH_BACKGROUND_URL,
			monthPlanBackgroundUrl: MONTH_PLAN_BACKGROUND_URL
		}
	},
	computed: {
		safeBanners() {
...
.task-center-stage + .task-center-stage {
	margin-top: 8rpx;
}

.task-center-stage-top,
.task-center-stage-top-buttons {
	overflow: hidden;
}

.task-center-stage-top + .task-center-stage-top-buttons {
	margin-top: -2rpx;
}

.task-center-stage-bg {
	display: block;
	width: 100%;
	height: auto;
	vertical-align: top;
...
.task-center-stage-overlay {
	position: absolute;
	inset: 0;
}

.task-center-stage-overlay-top-buttons {
	padding: 16rpx 18rpx 18rpx;
}

.task-center-stage-overlay-progress {
	padding: 14rpx 28rpx 12rpx;
}

.task-center-stage-overlay-ranking {
	padding: 16rpx 20rpx 24rpx;
}

.task-center-stage-overlay-links {
	padding: 22rpx 20rpx 20rpx;
}

.task-center-stage-overlay-plan {
	padding: 46rpx 24rpx 16rpx;
}

.task-center-banner-stage {
	padding: 16rpx 28rpx 10rpx;
}

.task-center-banner-image {
	display: block;
	width: 100%;
	height: auto;
	border-radius: 24rpx;
...
.task-center-hero-half-shell-ranking {
	...
	transform: translate(8rpx, -20rpx);
}
...
.task-center-hero-progress-summary-value.is-total {
	transform: translate(-44rpx, 6rpx);
}
